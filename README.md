...
Na Vercelu používej v administraci pole pro odkazy:

- `Nebo odkaz na fotku před rozkliknutím`
- `Nebo odkazy na další fotky`
- `Nebo odkazy na soubory ke stažení`

Odkazy na soubory můžeš psát jedním z těchto formátů:

```text
https://example.com/soubor.zip
Název souboru | https://example.com/soubor.zip
```
